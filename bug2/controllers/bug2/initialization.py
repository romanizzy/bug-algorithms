...
def init_robot(time_step=32):
    ...
    # define robot motors
    motor_1 = robot.getDevice("left wheel motor")
    motor_2 = robot.getDevice("right wheel motor")
    ...
    sonar_1 = robot.getDevice("s2")
    sonar_2 = robot.getDevice("s3")
    sonar_3 = robot.getDevice("s5")

    # enable distance sensors
    sonar_1.enable(time_step)
    sonar_2.enable(time_step)
    sonar_3.enable(time_step)
    print("Sonar Sensors ", sonar_1, sonar_2, sonar_3)

    # define position sensors
    pos_1 = robot.getDevice("left wheel sensor")
    pos_2 = robot.getDevice("right wheel sensor")
...
def update_motor_speed(input_omega=robot_omega):
    ...
    print("Motor 1 Speed Updated to: ", motor_1.getVelocity)
    print("Motor 2 Speed Updated to: ", motor_2.getVelocity)
